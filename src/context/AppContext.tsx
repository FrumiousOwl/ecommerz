...
import { AppState, CartItem, MessageThread, Order, Review, Ticket, User } from "@/lib/types";
...
export function AppProvider({ children }: { children: React.ReactNode }) {
  const [state, dispatch] = useReducer(reducer, initialState, (init) => {
    ...
    if (persisted) {
      return { ...init, ...persisted, products: init.products, vouchers: init.vouchers } as AppState;
    }
    return init;
  });
